# Chainlit project: ChatUI_with_RAG
## **Overview**
This project focuses on building chat AI that reads pdf file and answer to related question
The rest content of this article guide how to set up and run
